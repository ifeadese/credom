#!/usr/bin/env python3
"""Builds the CREDOM redesign artboards (.dc.html) plus plain preview HTML."""
import os, re

LOGO_LETTERS = "M 429.359 68.875 L 424.383 68.875 C 424.293 68.23 424.105 67.66 423.824 67.16 C 423.543 66.652 423.184 66.219 422.746 65.863 C 422.305 65.508 421.797 65.234 421.223 65.047 C 420.656 64.855 420.039 64.762 419.371 64.762 C 418.168 64.762 417.117 65.059 416.223 65.66 C 415.328 66.25 414.637 67.113 414.145 68.25 C 413.652 69.379 413.406 70.75 413.406 72.363 C 413.406 74.023 413.652 75.418 414.145 76.547 C 414.645 77.676 415.34 78.527 416.234 79.102 C 417.129 79.68 418.164 79.965 419.336 79.965 C 419.996 79.965 420.605 79.879 421.168 79.703 C 421.734 79.531 422.238 79.277 422.676 78.941 C 423.117 78.602 423.48 78.188 423.77 77.703 C 424.062 77.219 424.27 76.668 424.383 76.047 L 429.359 76.066 C 429.23 77.137 428.91 78.168 428.395 79.16 C 427.887 80.145 427.199 81.027 426.336 81.809 C 425.48 82.578 424.457 83.191 423.27 83.648 C 422.086 84.094 420.75 84.316 419.258 84.316 C 417.18 84.316 415.324 83.848 413.688 82.91 C 412.059 81.969 410.773 80.609 409.824 78.828 C 408.887 77.051 408.418 74.895 408.418 72.363 C 408.418 69.824 408.895 67.668 409.848 65.887 C 410.801 64.105 412.098 62.75 413.734 61.816 C 415.371 60.879 417.211 60.41 419.258 60.41 C 420.605 60.41 421.855 60.598 423.008 60.977 C 424.168 61.355 425.191 61.91 426.086 62.637 C 426.98 63.355 427.707 64.238 428.27 65.285 C 428.836 66.328 429.199 67.527 429.359 68.875 Z M 430.547 84 Z M 432.566 84 L 432.566 60.727 L 441.75 60.727 C 443.508 60.727 445.008 61.043 446.25 61.672 C 447.5 62.293 448.449 63.176 449.102 64.316 C 449.762 65.453 450.09 66.793 450.09 68.328 C 450.09 69.875 449.758 71.203 449.09 72.316 C 448.422 73.426 447.457 74.273 446.191 74.863 C 444.934 75.453 443.414 75.75 441.625 75.75 L 435.477 75.75 L 435.477 71.797 L 440.828 71.797 C 441.77 71.797 442.547 71.668 443.172 71.41 C 443.793 71.152 444.254 70.766 444.555 70.25 C 444.867 69.734 445.023 69.094 445.023 68.328 C 445.023 67.559 444.867 66.906 444.555 66.375 C 444.254 65.844 443.789 65.441 443.16 65.172 C 442.539 64.891 441.754 64.75 440.805 64.75 L 437.488 64.75 L 437.488 84 Z M 445.137 73.41 L 450.922 84 L 445.488 84 L 439.828 73.41 Z M 451.227 84 Z M 453.246 84 L 453.246 60.727 L 468.93 60.727 L 468.93 64.785 L 458.168 64.785 L 458.168 70.328 L 468.121 70.328 L 468.121 74.387 L 458.168 74.387 L 458.168 79.941 L 468.977 79.941 L 468.977 84 Z M 470.5 84 Z M 480.773 84 L 472.523 84 L 472.523 60.727 L 480.84 60.727 C 483.18 60.727 485.195 61.191 486.887 62.125 C 488.574 63.051 489.875 64.379 490.781 66.113 C 491.699 67.848 492.156 69.926 492.156 72.34 C 492.156 74.766 491.699 76.848 490.781 78.59 C 489.875 80.332 488.566 81.672 486.863 82.602 C 485.164 83.535 483.137 84 480.773 84 Z M 477.441 79.785 L 480.566 79.785 C 482.023 79.785 483.246 79.527 484.238 79.012 C 485.238 78.488 485.988 77.684 486.488 76.59 C 486.996 75.492 487.25 74.074 487.25 72.34 C 487.25 70.621 486.996 69.215 486.488 68.125 C 485.988 67.035 485.242 66.23 484.25 65.715 C 483.258 65.199 482.031 64.941 480.578 64.941 L 477.441 64.941 Z M 514.719 84 Z M 516.742 60.727 L 522.809 60.727 L 529.219 76.363 L 529.492 76.363 L 535.902 60.727 L 541.969 60.727 L 541.969 84 L 537.195 84 L 537.195 68.852 L 537.004 68.852 L 530.98 83.887 L 527.73 83.887 L 521.707 68.797 L 521.516 68.797 L 521.516 84 L 516.742 84 Z M 516.742 60.727"
LOGO_DOT = "M 512 70 C 512 74.969 507.969 79 503 79 C 498.031 79 494 74.969 494 70 C 494 65.031 498.031 61 503 61 C 507.969 61 512 65.031 512 70 Z M 512 70"
LOGO_BAR = "M 495 80.5 C 494.172 80.5 493.5 81.172 493.5 82 C 493.5 82.828 494.172 83.5 495 83.5 Z M 510.5 83.5 C 511.328 83.5 512 82.828 512 82 C 512 81.172 511.328 80.5 510.5 80.5 Z M 495 82 L 495 83.5 L 510.5 83.5 L 510.5 80.5 L 495 80.5 Z M 495 82"

def logo(h=24, color="currentColor"):
    w = round(h * 135.2 / 23.95)
    return (f'<svg aria-label="CREDOM" viewBox="406.8 60.4 135.2 23.95" height="{h}" width="{w}" style="display:block;color:{color};">'
            f'<path fill="currentColor" d="{LOGO_LETTERS}"></path><path fill="#D89A2E" d="{LOGO_DOT}"></path><path fill="currentColor" d="{LOGO_BAR}"></path></svg>')
...
CSS = r"""
    *, *::before, *::after { box-sizing: border-box; }
    ...
    ::selection { background: #D89A2E; color: #201D1B; }
    .wrap { max-width: 1240px; margin: 0 auto; padding: 0 40px; }
    .eyebrow { display: block; font-size: 13px; font-weight: 700; letter-spacing: 0.2em; text-transform: uppercase; color: #B87D1E; }
    ...
    .btn-lg { min-height: 60px; padding: 18px 40px; font-size: 16px; }
    .section { padding: 120px 0; }
    .head { display: flex; justify-content: space-between; align-items: flex-end; gap: 40px; margin-bottom: 64px; }
    .h-display { font-size: 96px; line-height: 0.9; letter-spacing: -0.015em; }
    .h-section { font-size: 64px; line-height: 0.96; }
    .h-state { font-family: 'Rokkitt', Georgia, serif; font-weight: 600; font-size: 52px; line-height: 1.1; letter-spacing: -0.01em; }
    .lede { font-size: 18px; line-height: 1.7; color: #4A443D; }
    .on-dark .lede { color: #C9C0B6; }
    .grid-2 { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 40px; }
    .grid-3 { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 18px; }
    .tag { display: inline-block; border: 1px solid #AAA59D; padding: 7px 12px; font-size: 11px; letter-spacing: 0.1em; text-transform: uppercase; font-weight: 700; line-height: 1.2; }
    .on-dark .tag { border-color: #4A443D; color: #C9C0B6; }
    ...
    .nav-links a.active::after { content: ""; position: absolute; left: 0; right: 0; bottom: -2px; height: 2px; background: #D89A2E; }
    .nav-links .btn { min-height: 44px; padding: 10px 22px; font-size: 14px; }
    .nav-mobile { display: none; align-items: center; gap: 12px; }
    .nav-mobile .btn { min-height: 44px; padding: 9px 14px; font-size: 13px; }
    .burger { width: 44px; height: 44px; border: 0; background: none; display: flex; flex-direction: column; align-items: flex-end; justify-content: center; gap: 7px; padding: 0 4px; cursor: pointer; color: inherit; }
    .burger span { display: block; height: 2px; border-radius: 2px; background: currentColor; }
    .burger span:first-child { width: 32px; } .burger span:last-child { width: 24px; }
    .drawer { display: none; }
    ...
    .hero-photo::after { content: ""; position: absolute; inset: 0; background: radial-gradient(ellipse 84% 132% at 83% 45%, rgba(32,29,27,0) 0%, rgba(32,29,27,0.13) 38%, rgba(32,29,27,0.55) 65%, rgba(32,29,27,0.85) 86%, rgba(32,29,27,0.95) 100%), linear-gradient(180deg, rgba(32,29,27,0.12) 0%, rgba(32,29,27,0) 35%, rgba(32,29,27,0.85) 100%); }
    .hero-ring { position: absolute; width: 640px; height: 640px; right: 8%; top: 12%; border: 1px solid rgba(216,154,46,0.6); border-radius: 50%; pointer-events: none; }
    .hero-ring::after { content: ""; position: absolute; inset: 95px; border: 1px solid rgba(216,154,46,0.25); border-radius: 50%; }
    .hero-lines { position: absolute; inset: 0; transform: scale(1.4); pointer-events: none; background-image: linear-gradient(130deg, transparent 30%, rgba(255,255,255,0.16) 30.12%, transparent 30.4%), linear-gradient(50deg, transparent 55%, rgba(255,255,255,0.1) 55.12%, transparent 55.4%); }
    ...
    .intro h2 { font-size: 104px; line-height: 0.88; letter-spacing: -0.03em; }
    .intro h2 span { color: #D89A2E; }
    .intro-copy { display: flex; flex-direction: column; gap: 22px; max-width: 480px; }

    /* STATEMENT (gold) */
    .statement { position: relative; overflow: hidden; background: #D89A2E; color: #201D1B; padding: 140px 0; }
    .statement .mark { position: absolute; right: -2vw; bottom: -0.15em; font-family: 'Rokkitt', Georgia, serif; font-weight: 900; font-size: 420px; line-height: 0.8; color: rgba(32,29,27,0.07); pointer-events: none; letter-spacing: -0.04em; user-select: none; }
    .statement-grid { position: relative; display: grid; grid-template-columns: 1.1fr 0.9fr; gap: 60px; align-items: center; }
    .statement h2 { font-size: 128px; line-height: 0.82; letter-spacing: -0.035em; color: #201D1B; }
    .statement h2 span { color: #5A2A17; }
    .statement .small { font-size: 12px; letter-spacing: 0.18em; text-transform: uppercase; font-weight: 700; color: #5A2A17; margin-bottom: 30px; display: block; }
    .statement-copy { display: flex; flex-direction: column; gap: 20px; max-width: 460px; font-size: 19px; line-height: 1.7; }
    .statement-copy strong { color: #201D1B; }
    .statement-copy p { color: #3F2A12; }

    /* SERVICE CARDS */
    .card { display: flex; flex-direction: column; justify-content: space-between; min-height: 240px; padding: 36px 32px; border-radius: 3px; }
    .card h3 { font-size: 26px; font-weight: 700; line-height: 1.1; margin: 20px 0 10px; }
    .card p { font-size: 15px; line-height: 1.6; opacity: 0.88; }
    ...
    /* WORK */
    .case { display: grid; grid-template-columns: 0.42fr 1fr; gap: 56px; padding: 64px 0; border-top: 1px solid #E4DDD2; align-items: start; }
    .case:last-of-type { border-bottom: 1px solid #E4DDD2; }
    .case-media { display: flex; flex-direction: column; gap: 16px; }
    .ph { position: relative; display: flex; align-items: center; justify-content: center; text-align: center; aspect-ratio: 4 / 3; border-radius: 3px; background: repeating-linear-gradient(45deg, #EAE3D8 0 10px, #F0EBE3 10px 24px); border: 1px dashed #B8AE9F; color: #6E665F; font-size: 12px; font-weight: 700; letter-spacing: 0.14em; text-transform: uppercase; padding: 20px; line-height: 1.6; }
    .on-dark .ph { background: repeating-linear-gradient(45deg, #2B2724 0 10px, #332E29 10px 24px); border-color: #5A534B; color: #8A8079; }
    .case h3 { font-size: 46px; font-weight: 700; line-height: 0.98; margin-bottom: 22px; }
    .case-copy { display: flex; flex-direction: column; gap: 16px; max-width: 720px; color: #4A443D; font-size: 16px; line-height: 1.7; }
    ...
    .about-grid { display: grid; grid-template-columns: 0.95fr 1.05fr; gap: 80px; align-items: start; }
    .stagger { font-size: 124px; line-height: 0.84; letter-spacing: -0.035em; position: sticky; top: 120px; }
    ...
    .value { min-height: 340px; padding: 32px; border-radius: 3px; display: flex; flex-direction: column; justify-content: space-between; gap: 28px; }
    .value h3 { font-size: 34px; font-weight: 700; line-height: 0.96; }
    ...
    /* SERVICES PAGE */
    .svc-head { padding: 110px 0 70px; }
    .svc-head .h-state { max-width: 1000px; }
    .svc-head .h-state em { color: #B87D1E; }
    .svc-index { display: flex; flex-wrap: wrap; gap: 10px; margin-top: 40px; }
    .svc-index a { display: inline-flex; align-items: center; gap: 10px; min-height: 44px; padding: 10px 16px; border: 1px solid #E4DDD2; border-radius: 2px; color: #201D1B; font-weight: 700; font-size: 14px; background: #FFFFFF; }
    .svc-index a:hover { border-color: #D89A2E; }
    .svc-index a b { font-family: 'Rokkitt', Georgia, serif; color: #B87D1E; font-weight: 700; font-size: 16px; }
    .blocks { display: flex; flex-direction: column; gap: 20px; padding-bottom: 120px; }
    .block { display: grid; grid-template-columns: 1fr 1fr; gap: 40px; padding: 56px; border-radius: 4px; }
    .block h3 { font-size: 38px; font-weight: 700; line-height: 1.05; margin: 12px 0 16px; }
    .block p { font-size: 16px; line-height: 1.7; opacity: 0.9; max-width: 480px; }
    .block ul { display: flex; flex-direction: column; gap: 12px; align-self: center; }
    .block li { position: relative; padding-left: 18px; font-size: 16px; line-height: 1.5; }
    .block li::before { content: ""; position: absolute; left: 0; top: 9px; width: 6px; height: 6px; border-radius: 50%; background: currentColor; }
    ...
    .form-note { font-size: 13px; color: #6E665F; }
    .aside { background: #F0EBE3; border-radius: 4px; padding: 48px; display: flex; flex-direction: column; gap: 26px; }
    .aside h2 { font-size: 30px; font-weight: 700; }
    .aside .lbl { display: block; font-size: 12px; font-weight: 700; letter-spacing: 0.18em; text-transform: uppercase; color: #B87D1E; margin-bottom: 6px; }
    .aside a, .aside span.v { color: #201D1B; font-size: 17px; font-weight: 600; }
    .aside .addr { font-size: 16px; line-height: 1.7; color: #4A443D; }
    .aside .tagline { border-top: 1px solid #DDD4C7; padding-top: 24px; font-family: 'Rokkitt', Georgia, serif; font-style: italic; font-weight: 600; font-size: 22px; line-height: 1.4; color: #B87D1E; }

    /* WORK PAGE */
    .work-hero { background: #201D1B; color: #FAF7F2; padding: 120px 0 90px; }
    .work-hero h1 { font-size: 128px; line-height: 0.84; letter-spacing: -0.035em; margin-top: 26px; }
    .work-hero h1 span { color: #D89A2E; }
    .work-hero .lede { max-width: 620px; margin-top: 34px; }

    /* MOBILE */
    @media (max-width: 640px) {
      .wrap { padding: 0 20px; }
      .section { padding: 72px 0; }
      .head { flex-direction: column; align-items: flex-start; gap: 18px; margin-bottom: 36px; }
      .h-display { font-size: 60px; }
      .h-section { font-size: 42px; }
      .h-state { font-size: 30px; }
      .lede { font-size: 16px; }
      ...
      .hero-ring, .hero-lines { display: none; }
      ...
      .process-head h2 { font-size: 60px; }
      .steps { margin-top: 44px; }
      .step { grid-template-columns: minmax(0, 1fr); gap: 10px; padding: 28px 0; }
      .step h3 { font-size: 30px; }
      .step.measure { margin: 0; padding: 28px 20px; }
      .case { grid-template-columns: minmax(0, 1fr); gap: 28px; padding: 44px 0; }
      .case h3 { font-size: 32px; }
      .rail { flex-direction: column; align-items: stretch; gap: 0; padding: 0; border: 0; }
      ...
      .vm-card { padding: 56px 20px; min-height: 0; gap: 28px; }
      .vm-card h3 { font-size: 38px; }
      .why-grid { grid-template-columns: minmax(0, 1fr); gap: 32px; }
      .why h2 { font-size: 68px; position: static; }
      .why-high { font-size: 26px; }
      .values-head h2 { font-size: 56px; }
      .bento { grid-template-columns: minmax(0, 1fr); margin-top: 40px; }
      ...
      .contact-hero .mark { font-size: 180px; }
      .contact-body { grid-template-columns: minmax(0, 1fr); gap: 40px; padding-top: 64px; padding-bottom: 72px; }
      .aside { padding: 32px 24px; }
      .form .btn { width: 100%; }
      .work-hero { padding: 72px 0 56px; }
...
ARROW = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="width:16px;height:16px;"><path d="M5 12h14"></path><path d="m13 6 6 6-6 6"></path></svg>'
DOWN = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 5v14"></path><path d="m6 13 6 6 6-6"></path></svg>'
CHEV = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg>'
MAIL = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2.5" y="4.75" width="19" height="14.5" rx="2.5"></rect><path d="m3.5 7 7.6 5.3a1.6 1.6 0 0 0 1.8 0L20.5 7"></path></svg>'
...
# ------------------------------------------------------------------ CONTENT
SERVICES = [
  ("01", "Brand Experience Strategy", "We set the strategic foundation before a single activation is planned or a single media space is booked.",
   ["Brand and campaign strategy", "Brand exhibitions and pop-ups", "Brand experience design and storytelling", "Go-to-market activation planning"],
   "#D89A2E", "#201D1B", "rgba(32,29,27,0.55)"),
  ("02", "Experiential Marketing &amp; Activation", "We put your brand directly in front of your audience through live, real-world experiences that drive genuine trial, loyalty, and advocacy.",
   ["Market and retail activations", "Product sampling and consumer engagement", "Roadshows and multi-location deployment", "PR stunts and high-impact campaigns"],
   "#201D1B", "#FAF7F2", "#D89A2E"),
  ("03", "Corporate Events &amp; Experiences", "We produce polished, professionally managed events, sponsored experiences, and brand-owned platforms that reflect your brand's ambition, credibility, and long-term equity.",
   ["Proprietary event creation", "Brand sponsorship strategy and execution", "Sponsor experience design", "Product launches", "Conferences and summits", "Award ceremonies and gala dinners", "Cultural festivals"],
   "#C50E8B", "#FAF7F2", "rgba(250,247,242,0.6)"),
  ("04", "Traditional Media", "We plan, place, and manage traditional media campaigns that extend your brand messaging and maximise reach at every stage of the consumer journey.",
   ["Television and radio campaign planning and buying", "Print media strategy and placement", "Media schedule development and audience targeting", "Integrated campaign management"],
   "#5A2A17", "#FAF7F2", "#D89A2E"),
  ("05", "Out-of-Home (OOH) Marketing", "We design and deploy OOH campaigns that make your brand unmissable in the environments where your audience lives, works, and moves.",
   ["Billboard and large-format outdoor advertising", "Transit and commuter media placements", "Street furniture, mall, and point-of-sale OOH", "Digital OOH and programmatic outdoor", "OOH strategy, site selection, and media buying"],
   "#18827B", "#FAF7F2", "rgba(250,247,242,0.6)"),
  ("06", "Digital Marketing", "We build and manage digital marketing campaigns that help your brand stay visible, relevant, and competitive across the platforms where your audience spends their time.",
   ["Social media marketing", "Display marketing", "Performance tracking and reporting", "Email marketing and CRM campaigns", "Influencer and creator marketing", "Paid digital advertising", "Content marketing and creative production"],
   "#2B2724", "#FAF7F2", "#D89A2E"),
]
SHORT = ["We set the strategic foundation before a single activation is planned.",
         ...
         "Physical brand presence that makes you unmissable.",
         "Turning online attention into engagement, leads and sales."]
PREVIEW_TITLES = ["Brand Experience Strategy", "Experiential Marketing &amp; Activation", "Corporate Events &amp; Experiences", "Traditional Media", "Out-of-Home (OOH)", "Digital Marketing"]

STEPS = [
  ("01", "Discover", "#D89A2E", "We dive deep into your brand, audience, objectives, competitive landscape, and media environment. Before any concept is sketched, we understand what success looks and feels like at every level."),
  ("02", "Design", "#C50E8B", "We develop bold, insight-led concepts and immersive integrated experience strategies that connect your brand story across all marketing channels."),
  ("03", "Develop", "#18827B", "We plan every detail from logistics, production, and execution frameworks to media scheduling and site selection, ensuring every channel is aligned and deployed with precision."),
  ("04", "Deliver", "#5A2A17", "We seamlessly execute every element end-to-end, bringing the campaign to life with the same standard of precision, control, and excellence across every touchpoint."),
  ("05", "Measure", "#201D1B", "We evaluate performance across every channel, quantifying reach, engagement, and commercial impact to optimise for future growth."),
]

CASES = [
  ("Case Study 01 · Lagos", "FUTURE IN MOTION", "AltDrive EV Experience 2.0",
   ...
   ["Brand Experience", "Launch", "Lagos"], "[Event photo — AltDrive EV Experience 2.0]"),
  ("Case Study 02 · Abuja", "The Midea Pro Shop", "Grand Launch &amp; Partners' Conference",
   ["We delivered a dual-format activation that turned a product launch into a full brand moment. From the high-energy grand opening of The Midea Pro Shop to a polished partners' conference held the same evening, we built two distinct experiences under one strategic vision.",
    "Every touchpoint was intentional, driving footfall, deepening trade relationships, and solidifying Midea's market authority in Abuja."],
   "A seamless, end-to-end production that proved experiential excellence and commercial impact aren't a trade-off, they're the brief.",
   ["Brand Experience", "Launch", "Conference", "Abuja"], "[Event photo — Midea Pro Shop, Abuja]"),
  ("Case Study 03 · Eastern States", "Terra", "August Meeting Activation",
   ["The August Meeting is a significant social and cultural tradition among Igbo women and wives. Recognising the power of this moment, we activated the Terra brand across 6 locations in Anambra, Enugu, and Imo State, meeting consumers where the conversation was already happening.",
    "Through targeted brand talks, dry sampling, and grassroots ambassador engagement, we created genuine trial moments and drove on-ground sales across local communities and churches."],
   "Meeting consumers where the conversation was already happening.",
   ["Activation", "Sampling", "Grassroots", "6 Locations"], "[Event photo — Terra August Meeting]"),
]

VALUES = [
  ("01", "People-Centricity", "We design for humans first, brands second. Every experience we create starts with one question: how do we want people to feel?", "#C50E8B", "#FAF7F2", "span2"),
  ("02", "Reliability &amp; Attention to Detail", "We do what we say, deliver on our promise, and sweat the small things so the big moments land exactly as they should.", "#5A2A17", "#FAF7F2", "span2"),
  ("03", "Innovation", "Every brief is an invitation to push further. We challenge the expected approach and explore what has not been done.", "#D89A2E", "#201D1B", "span2"),
  ("04", "Excellence", "Excellence at CREDOM means that every touchpoint, visible and invisible, reflects the full measure of our craft.", "#18827B", "#FAF7F2", "span3"),
  ("05", "Teamwork", "Behind every seamless campaign is a team working in precise coordination, internally and with our clients.", "#FFFFFF", "#201D1B", "span3"),
]

def case_html(c, dark=False, link=True):
    label, title, sub, paras, take, tags, ph = c
    p = "".join(f"<p>{x}</p>" for x in paras)
    t = "".join(f'<span class="tag">{x}</span>' for x in tags)
    lk = f'<a href="#" class="case-link">Read the case study {ARROW}</a>' if link else ""
    return f'''
<article class="case">
  ...
  <div>
    <span class="eyebrow" style="margin-bottom:14px;">{sub}</span>
    <h3>{title}</h3>
    <div class="case-copy">{p}<p class="take">{take}</p></div>
    <div class="case-meta">{t}</div>
    {lk}
  </div>
</article>'''
...
def rail():
    return '''
<div class="rail">
  <div><img src="altdrive.png" alt="AltDrive"></div>
  <div><img src="altbank.svg" alt="AltBank" class="alt"></div>
  <div><img src="midea.png" alt="Midea" class="midea"></div>
</div>'''
...
<section class="statement">
  <div class="mark" aria-hidden="true">CREDOM</div>
  <div class="wrap statement-grid">
    <h2><span class="small">Why experiences matter</span>Most<br>Marketing<br>Is <span>Ignored.</span></h2>
    <div class="statement-copy">
      <p>Consumers scroll past ads. Skip commercials. Forget campaigns.</p>
      <p><strong>But experiences? Experiences create emotion, conversation, and memory. Brands that win today don't just market to people. They involve them.</strong></p>
    </div>
  </div>
</section>
...
<section class="about-hero">
  <div class="wrap about-grid">
    ...
    <div class="about-copy">
      <span class="eyebrow">About CREDOM</span>
      <p>We are an integrated brand experience agency built to shape how people encounter, understand, and connect with brands across every touchpoint.</p>
      <p>We unify strategy, creativity, and execution to design the full arc of a brand's presence; from immersive live experiences and cultural activations to out-of-home and media channels that extend reach and sustain relevance.</p>
      <p>Every campaign is engineered with an insight-led strategy to resonate, inspire action, and leave a lasting imprint. From high-energy brand activations and corporate events to broadcast media and out-of-home executions, we approach every project with intentionality and a deep understanding of audience behaviour.</p>
      <p>We pair strategic rigour with creative excellence to ensure every brand interaction lands with precision and purpose.</p>
    </div>
  </div>
</section>

<section class="quote-band">
  <div class="wrap"><div class="rule-gold"></div><blockquote>"We believe the most powerful brand experiences are not merely seen or attended, they are felt."</blockquote></div>
</section>
...
<section class="section why">
  <div class="wrap why-grid">
    ...
    <div class="why-copy">
      ...
      <p>Our creative production capabilities mean we do not just plan your campaigns. We craft every visual and spatial element, and every audience interaction, to draw people deeper into your brand world.</p>
      <p class="why-high">Our end-to-end project management ensures nothing falls through the gaps, from the first brief to the final impression.</p>
    </div>
  </div>
</section>
...
<section class="svc-head">
  <div class="wrap">
    ...
    <p class="h-state">Our capabilities span the full spectrum of experiential marketing. <em style="font-style:italic;">Every service works independently or as part of a fully integrated campaign strategy.</em></p>
    <div class="svc-index">{index}</div>
  </div>
</section>
...
<section class="wrap contact-body">
...
for name, body in builds.items():
    wrap_cls = ' class="menu-open"' if name == "MenuMobile" else ""
    body = f'<div{wrap_cls} style="width:100%;min-height:100%;background:#FAF7F2;position:relative;">{body}\n</div>'
    with open(f"{name}.dc.html", "w") as f:
        f.write(HEAD % CSS + body + TAIL)
    with open(f"preview/{name}.html", "w") as f:
        f.write(PREVIEW_HEAD % (name, CSS) + body + "\n</body></html>\n")
print("built", ", ".join(builds))
