...
CSS = r"""
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .about-grid { display: grid; grid-template-columns: minmax(0, 0.95fr) minmax(0, 1.05fr); gap: 80px; align-items: start; }
    .stagger { font-size: 104px; line-height: 0.84; letter-spacing: -0.035em; position: sticky; top: 120px; }
    .stagger span { display: block; }
    .stagger span:nth-child(2) { color: #D89A2E; margin-left: 6%; }
    .stagger span:nth-child(3) { margin-left: 12%; }
