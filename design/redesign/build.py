...
CSS = r"""
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .hero-photo { position: absolute; top: 0; right: 0; width: 76%; height: 100%; }
    .hero-photo img { width: 100%; height: 100%; object-fit: cover; object-position: 62% center; }
    .hero-photo::after { content: ""; position: absolute; inset: 0; background: radial-gradient(ellipse 88% 140% at 84% 45%, rgba(32,29,27,0) 0%, rgba(32,29,27,0.12) 35%, rgba(32,29,27,0.5) 62%, rgba(32,29,27,0.82) 84%, rgba(32,29,27,0.93) 100%), linear-gradient(180deg, rgba(32,29,27,0.12) 0%, rgba(32,29,27,0) 35%, rgba(32,29,27,0.85) 100%); }
