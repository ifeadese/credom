...
export default function ServicesPage() {
  return (
    <>
      {/* HEADER */}
      <section className="pb-[clamp(40px,5vw,70px)] pt-[clamp(70px,9vw,120px)]">
        <Container>
      ...
      {/* SERVICE BLOCKS */}
      <section className="pb-[clamp(80px,10vw,120px)]">
          ...
          {services.map((service) => {
            ...
            return (
              <div
                ...
                className={`grid scroll-mt-24 grid-cols-[repeat(auto-fit,minmax(min(280px,100%),1fr))] gap-8 rounded-block p-[clamp(24px,4vw,56px)] ${t.card}`}
              >
                <div>
                  <span
